...
namespace SharedModule
{
    public static class DPIHelper
    {
        ...
        [DllImport("User32.dll", SetLastError = true)]
        private static extern bool AreDpiAwarenessContextsEqual(DPI_AWARENESS_CONTEXT valueA, DPI_AWARENESS_CONTEXT valueB);
        ...
        public static DPI_AWARENESS_CONTEXT GetWindowDpiAwareness(IntPtr hWnd)
        {
